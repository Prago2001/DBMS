...
class AssignmentCreateForm(forms.ModelForm):
    class Meta:
        model = Assignment
        fields = ['course_name','title', 'content', 'marks',]
...
class AssignmentSubmissionForm(forms.ModelForm):
    class Meta:
        ...
        fields = ['course_name','title','name', 'university_id', 'content', 'file']
...
class MarksForm(forms.ModelForm):
    ...
    university_id = forms.CharField(disabled=True)
    content = forms.CharField(disabled=True,required=False)
    class Meta:
        model = AssignmentSubmission
        fields = ['name','university_id','content','file','marksObtained']
