...
from .forms import CourseCreateForm, AssignmentCreateForm, AssignmentSubmissionForm,MarksForm
...
#Enter Marks View
class AssSubmissionEnterMarks(UpdateView):
    model = AssignmentSubmission
    form_class = MarksForm
    success_url = reverse_lazy("core:assignment-submission-list")
    template_name = 'core/instructor/enterMarks.html'
    paginate_by = 10
